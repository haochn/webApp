...
(function(){	
	...
	Util = (function() {
     ...
     //获取章节信息
		 ...
		 $.get('./data/4/chapter.json',function(data){
			var url,
			...
			//todo 实现与阅读器相关的数据交互方法
				...
				if(data.result==0){
					//设置默认id为0（第一章节内容）
					chapter_id_4=Util.StorageGetter('chapter_id_4');
					chapter_id_4=parseInt(chapter_id_4,10);
					chapter_id_4=chapter_id_4||0;
					url='./data/4/data'+chapter_id_4+'.json';
		...
		$('#next_button').click(function(){
			chapter_id_4=parseInt(chapter_id_4,10);
			if(chapter_id_4>=totalChapter){			
				return ;
			}
			chapter_id_4+=1;
			
			Util.StorageSetter('chapter_id_4',chapter_id_4)
			getData()
		...
		$('#menu_button').click(function(){
            ...
            window.location.href="./booklist4.html"
